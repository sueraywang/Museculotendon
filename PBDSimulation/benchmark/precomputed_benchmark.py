...
from precomputedSim import Simulator as PrecomputedSimulator
        ...
        for constraint in self.constraints:
            ...
            with self.profiler.time_operation("model_forward"):
                ...
                try:
                    ...
                    import Simulator
                    if hasattr(Simulator, 'model'):
                        C = Simulator.model(inputs)
                    else:
    ...
    def xpbd_substep(self, activation):
        ...
        for constraint in self.constraints:
            ...
            with self.profiler.time_operation("model_forward"):
                ...
                try:
                    import precomputedSim
                    if hasattr(precomputedSim, 'model'):
                        C = precomputedSim.model(network_inputs)
                    else:
